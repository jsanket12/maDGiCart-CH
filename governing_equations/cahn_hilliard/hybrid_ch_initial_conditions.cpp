#include "hybrid_ch_initial_conditions.hpp"
...
HybridCHInitialConditions::HybridCHInitialConditions(HybridCHParameters& params)
...
void
HybridCHInitialConditions::set(const TimeIntegrableRHS& rhs, SolutionState& state) const
{
